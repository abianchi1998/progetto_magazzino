...
def read_csv_products():
    ...
    try: # Gestione degli errori, serve per non mandare in crash il server 
        with open(CSV_FILE, mode="r", encoding="utf-8") as file:
            ...
            for row in reader:
                ...
                products.append(row)
    except FileNotFoundError: #Gestione degli errori, serve per non mandare in crash il server 
